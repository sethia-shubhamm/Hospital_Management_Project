...
<body>
    ...
    <div class="desktop">
        ...
        <div class="mainContainer">
            ...
            <div class="loginForm">
                <div class="slider">
                    <button><a href="../login/index.php">Patient</a></button>
                    <button class="active"><a href="index.php">Doctor</a></button>
                ...
                <form id="loginForm" class="inputFeilds" action="../login/login_process.php" method="POST">
                    <div class="right">
    ...
    <button type="button" id="demoButton">
        <div class="floating-demo-btn" id="tryDemoBtn">
            <div class="demo-icon">
                <span>Try Demo</span>
            </div>
        </div>
