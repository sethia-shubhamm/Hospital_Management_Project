...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($patientId)) {
        ...
        if (!$patientResult) {
            ...
            $registerDate = isset($_POST['registerDate']) && !empty($_POST['registerDate']) ? $_POST['registerDate'] : NULL;
            ...
            if (empty($patientName)) {
                ...
                if ($registerDate) {
                    $updatePatientQuery .= ", RegisterDate = '$registerDate'";
                }
                ...
                if (mysqli_query($conn, $updatePatientQuery)) {
                    ...
                    logError("Failed to update patient: " . mysqli_error($conn));
                    $response['message'] = "Failed to update patient. Please try again.";
                }
            }
        }
    }
